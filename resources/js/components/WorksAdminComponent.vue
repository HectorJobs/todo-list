                    ...
                    <div class="card ml-5 mr-5">
                        ...
                        <div class="row">
                                ...
                                <div class="col-lg-4 float-right">
                                    <a href="#modalStore" data-toggle="modal" class="btn btn-success">Agregar trabajo</a>
                                </div>
                            </div>
                        </div>
                        <div class="card-body">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <span class="modal-title">Agregar trabajo</span>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <input type="text" v-model="work.name" class="form-control" required>
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="name">Asinado a:*</label>
                                <select name="user_id" id="user_id" v-model="work.user_id" class="form-control" required>
                                    <option v-for="user in arrayUsers" :key="user.id" :value="user.id" v-text="user.name"></option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-6">
                                ...
                                <select name="complexity_id" id="complexity_id" v-model="work.complexity_id" class="form-control" required>
                                    <option v-for="complexity in arrayComplexities" :key="complexity.id" :value="complexity.id" v-text="complexity.name"></option>
                                </select>
                            </div>
                            <div class="form-group col-lg-6">
                                <label for="name">Estatus:*</label>
                                <select name="progress_id" id="progress_id" v-model="work.progress_id" class="form-control" required>
                                    <option v-for="progress in arrayProgress" :key="progress.id" :value="progress.id" v-text="progress.name"></option>
                                </select>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-12">
                                ...
                                <input type="date" v-model="work.dead_line" class="form-control" required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="form-group col-lg-12">
                                <label for="name">Descripción:*</label>
                                <textarea name="description" id="description" required v-model="work.description" cols="30" rows="10" class="form-control"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-secondary-outline" data-dismiss="modal">Cancelar</button>
                        <button class="btn btn-success" @click="storeWork()">Guardar trabajo</button>
                    </div>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        storeWork(){
            let that = this;
            axios.post('http://localhost:8000/api/store/work', that.work).then((result) => {
